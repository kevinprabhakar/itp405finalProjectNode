...
it('should return a status of 204 when attempting to delete a recipe that does exist',()=>{
    return frisby
    .delete('http://localhost:8000/api/recipes/10')
    .expect('status',204);
});
